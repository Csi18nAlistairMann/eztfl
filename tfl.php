...
/*
  ...
  # tfl DID use five machines at api.tfl.gov.uk 104.16.24.236, 104.16.25.236 ... 104.16.28.236
  # Now it's:
  tfl1=104.16.100.13/32
  tfl2=104.16.101.13/32

  iptables -A OUTPUT -o $ifout -p TCP -s $any -d $tfl1 -m owner --uid-owner www-data --dport 443 -m limit --limit 300/minute --limit-burst 300 -j ACCEPT
  iptables -A OUTPUT -o $ifout -p TCP -s $any -d $tfl1 -m owner --uid-owner www-data --dport 443 -j DROP
  iptables -A OUTPUT -o $ifout -p TCP -s $any -d $tfl2 -m owner --uid-owner www-data --dport 443 -m limit --limit 300/minute --limit-burst 300 -j ACCEPT
  iptables -A OUTPUT -o $ifout -p TCP -s $any -d $tfl2 -m owner --uid-owner www-data --dport 443 -j DROP
*/
